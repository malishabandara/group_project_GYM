  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <Icon name="search" size={20} color="#764ABC" style={styles.searchIcon}/>
        <TextInput
        ...
        renderItem={({ item }) => (
          ...
          >
            <View style={styles.userContent}>
              <Image
                source={{ uri: item.profile_pic || 'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.pngmart.com%2Ffiles%2F15%2FGym-Fitness-Female-PNG-Transparent-Image.png&f=1&nofb=1&ipt=f45b80c45e4ea2d11a08cf961bddac58d6acabfba2bdc7eee1339480ca15cd97&ipo=images' }}
